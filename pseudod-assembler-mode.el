...
(defconst pseudod-assembler-font-lock-keywords
  '(("\\<\\(\\(END\\)?\\(SECTION\\|PROC\\)\\|LOCAL\\|PARAM\\|RETN\\|L[SG]ETC?\\|[IFLB]CONST\\|\\(OPN\\|CLS\\)\\(FRM\\|EXP\\)\\|E\\(INIT\\|NEW\\|XP\\)\\|ROTM?\\|T?\\(DYN\\)?MSGV?\\|SUM\\|SUB\\|MUL\\|DIV\\|NAME\\|CHOOSE\\|[GL][ET]\\|JMP\\|MTRUE\\|CMP\\(N\\|REF\\)?EQ\\|NOT\\|MK0?\\(CLZ\\|OBJ\\|ARR\\)\\|VARIADIC\\|METHOD\\|PRN\\|NL\\|PDVM\\|PLATFORM\\|STRING\\|BIG\\(INT\\|DEC\\)\\|PROTOTYPE\\|S?POP\\|SPUSH\\|OPEQ\\|MODULE\\|EXP\\|\\(SAVE\\)?IMPORT\\|OBJTAG\\)\\>" . font-lock-keyword-face)
    ("\\([,#()]\\)" . font-lock-keyword-face))
